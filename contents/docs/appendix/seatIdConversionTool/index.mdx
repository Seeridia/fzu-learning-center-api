---
title: Seat ID Conversion Tool
description: 用以将座位ID转换为座位号的工具
---

程序会检索同目录下的 `seatIdReferenceTable.csv` 文件，如果不存在则会从 [GitHub](https://raw.githubusercontent.com/Seeridia/fzu-learning-center-api/main/source/seatIdReferenceTable.csv) 获取。

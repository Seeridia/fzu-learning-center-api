...
程序会检索本地的 `seatIDReferenceTable.csv` 文件，如果不存在则会从 [GitHub](https://raw.githubusercontent.com/Seeridia/fzu-learning-center-api/main/source/seatIDReferenceTable.csv) 获取。
